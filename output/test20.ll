...
define i32 @main() {
	...
	%_9 = call i8* @calloc(i32 1, i32 28)
...
define i32 @C23.init(i8* %this, i8* %.a) {
	...
	%_8 = getelementptr i8, i8* %this, i32 32
	%_9 = bitcast i8* %_8 to i32*
	%_10 = load i32, i32* %_9
	%_7 = call i32 %_6(i8* %this, i32 %_10)
	%_11 = getelementptr i8, i8* %this, i32 28
	%_12 = bitcast i8* %_11 to i32*
	store i32 %_7, i32* %_12
	%_13 = load i8*, i8** %a
	; A23.init : 0
