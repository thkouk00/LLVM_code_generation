...
@.B_vtable = global [2 x i8*] [i8* bitcast (i1 (i8*)* @B.set to i8*), i8* bitcast (i32 (i8*)* @A.get to i8*)]

@.C_vtable = global [3 x i8*] [i8* bitcast (i1 (i8*)* @C.reset to i8*), i8* bitcast (i1 (i8*)* @B.set to i8*), i8* bitcast (i32 (i8*)* @A.get to i8*)]
