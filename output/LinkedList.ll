...
if8: 
	...
	%_34 = load i8*, i8** %_33
	%_35 = bitcast i8* %_34 to i1 (i8*, i32, i32)*
	%_37 = load i32, i32* %aux02
	%_38 = getelementptr i8, i8* %this, i32 12
	%_39 = bitcast i8* %_38 to i32*
	%_40 = load i32, i32* %_39
	%_36 = call i1 %_35(i8* %this, i32 %_37, i32 %_40)
	%_41 = xor i1 1, %_36
	br i1 %_41, label %if28, label %if29
...
if42: 
	...
	%_58 = xor i1 1, %_57
	br i1 %_58, label %if48, label %if49
...
if3: 
	%_11 = load i32, i32* %num1
	%_12 = load i32, i32* %aux02
	%_13 = icmp slt i32 %_11, %_12
	%_14 = xor i1 1, %_13
	br i1 %_14, label %if8, label %if9
...
define i8* @List.Delete(i8* %this, i8* %.e) {
	...
	%_11 = xor i1 1, %_10
		br i1 %_11, label %and14, label %and15
	and14:
	%_17 = load i1, i1* %ret_val
	%_18 = xor i1 1, %_17
		br label %and15
	and15:
		br label %and16
	and16:
		%_12 = phi i1 [0, %and14], [%_18, %and15]
...
if21: 
	%_61 = load i1, i1* %ret_val
	%_62 = xor i1 1, %_61
	br i1 %_62, label %if58, label %if59
...
define i32 @List.Search(i8* %this, i8* %.e) {
	...
	%_10 = xor i1 1, %_9
	br i1 %_10, label %loop7, label %loop8
