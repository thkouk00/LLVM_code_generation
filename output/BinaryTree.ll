...
if59: 
	...
	%_67 = bitcast i8* %_66 to i8***
	%_68 = load i8**, i8*** %_67
	%_69 = getelementptr i8*, i8** %_68, i32 7
	%_70 = load i8*, i8** %_69
	%_71 = bitcast i8* %_70 to i1 (i8*)*
	%_72 = call i1 %_71(i8* %_66)
	%_73 = xor i1 1, %_72
		br i1 %_73, label %and76, label %and77
	and76:
	%_79 = load i8*, i8** %current_node
	; Tree.GetHas_Left : 8
	%_80 = bitcast i8* %_79 to i8***
	%_81 = load i8**, i8*** %_80
	%_82 = getelementptr i8*, i8** %_81, i32 8
	%_83 = load i8*, i8** %_82
	%_84 = bitcast i8* %_83 to i1 (i8*)*
	%_85 = call i1 %_84(i8* %_79)
	%_86 = xor i1 1, %_85
		br label %and77
	and77:
		br label %and78
	and78:
		%_74 = phi i1 [0, %and76], [%_86, %and77]
